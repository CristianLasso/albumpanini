...
describe('Album Service', () => {     
    describe('When a request to edit one specific album is made', () => {         
        beforeAll(async () => {             
            await provider.setup();             
            await provider.addInteraction({     
                uponReceiving: 'a request to edit one album',     
        ...
        test('should return the correct data', async () => {             
         const response = await AlbumController.updateAlbum("118263");
